...
A casting tree example might look like the following image. As alyways, the branching from one channel into two is problematic to get right (cross section areas must add up!):
